...
public class Constants {
    ...
    public static final CreateCustomerDTO CREATE_CUSTOMER_DTO_1 = new CreateCustomerDTO("Igo", "Fir", "igofir@test.com", new Address("testStreet2", "11", "testCity2", "01633"), "0123456789");
}
